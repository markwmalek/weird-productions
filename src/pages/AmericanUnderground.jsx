...
export default function AmericanUnderground() {
  return (
    <div className="au">
      ...
      {/* ─── Space 04: AU Yearbook Room ───────────────────────────────────── */}
      <section className="au__pspace au__pspace--alt">
        <div className="au__pspace-inner">
          <div className="au__pspace-header">
            <span className="au__pspace-num">04</span>
            <div className="au__pspace-title-group">
              <h2 className="au__pspace-name">AU Yearbook Room</h2>
              <p className="au__pspace-floor">1st Floor</p>
            </div>
          </div>
          ...
          <div className="au__pspace-lower">
            ...
            <div className="au__pspace-scope">
              <p className="au__pspace-scope-label">Scope</p>
              <p className="au__pspace-scope-text">Large display hutch, oriental area rug, floor lamp &amp; spotlights, coffee table, styling layer for shelves &amp; surfaces</p>
            </div>
          </div>
          ...
          <div className="au__pspace-art">
            ...
            <div className="au__pspace-art-grid">
              <div className="au__pspace-art-item">
                <img src="/images/au/p17_0.png" alt="Keith Haring Print" />
                <p>Keith Haring Print</p>
              </div>
              <div className="au__pspace-art-item">
                <img src="/images/au/p17_1.png" alt="Michael Rosenburg Photograph" />
                <p>Michael Rosenburg Photograph</p>
              </div>
              <div className="au__pspace-art-item">
                <img src="/images/au/p17_2.png" alt="Lego Skyline" />
                <p>Lego Skyline</p>
              </div>
              <div className="au__pspace-art-item">
                <img src="/images/au/p17_5.png" alt="Star Wars Sculpture" />
                <p>Star Wars Sculpture</p>
              </div>
              <div className="au__pspace-art-item">
                <img src="/images/au/p17_4.png" alt="Boxer Oil Painting by HT Johnson" />
                <p>Boxer Oil Painting — HT Johnson</p>
              </div>
              <div className="au__pspace-art-item">
                <img src="/images/au/p17_3.png" alt="Metal Numbers" />
                <p>Metal Numbers</p>
              </div>
            </div>
          </div>
      ...
      {/* ─── Space 05: Assigned Desks ─────────────────────────────────────── */}
      <section className="au__pspace">
        <div className="au__pspace-inner">
          <div className="au__pspace-header">
            <span className="au__pspace-num">05</span>
            <div className="au__pspace-title-group">
              <h2 className="au__pspace-name">Assigned Desks</h2>
              <p className="au__pspace-floor">1st Floor</p>
            </div>
          </div>
          ...
          <div className="au__pspace-lower">
            ...
            <div className="au__pspace-scope">
              <p className="au__pspace-scope-label">Scope</p>
              <p className="au__pspace-scope-text">Spotlights, curated art program across desk area</p>
            </div>
          </div>
          ...
          <div className="au__pspace-art">
            ...
            <div className="au__pspace-art-grid">
              <div className="au__pspace-art-item">
                <img src="/images/au/p19_3.png" alt="4 Horsemen" />
                <p>4 Horsemen</p>
              </div>
              <div className="au__pspace-art-item">
                <img src="/images/au/p19_0.png" alt="Custom Painting by McKayla Walker" />
                <p>Custom Painting — McKayla Walker</p>
              </div>
              <div className="au__pspace-art-item">
                <img src="/images/au/p19_1.png" alt="Series of Paintings by Reneesha" />
                <p>Series of Paintings — Reneesha</p>
              </div>
            </div>
          </div>
        </div>
